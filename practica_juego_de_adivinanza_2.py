...
for i in range(1, 10):
	...
	while maquina_1 != secreto and maquina_2 != secreto:
		...
		if maquina_1 < secreto:
			...
			print(f'maquina_1 has perdidos un intento te quedan: {max_intentos_maquina_1}\n')
		...
		if maquina_1 != secreto:
			...
			if maquina_2 < secreto:
				...
				print(f'maquina_2 has perdidos un intento te quedan: {max_intentos_maquina_2}\n')
				...
				if max_intentos_maquina_2 == 0:
					...
					print('como maquina_2 a fallado todos sus intentos maquina_1 gana\n')
					victorias_maquina_1 += 1
					break
